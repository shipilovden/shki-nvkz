...
Вы можете изменить заголовок и описание в файле `content.js`.
...
В `Mailchimp.tsx` есть предварительно настроенный фон, который вы можете изменить в объекте `mailchimp`. Настройте графические элементы, такие как градиент, точки, линии и сетку, и настройте их внешний вид для блока рассылки.
