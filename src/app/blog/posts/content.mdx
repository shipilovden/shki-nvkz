...
`const person = {
    ...
    lastName: "Школа",
    get name() {
      return "Новокузнецкая школа креативных индустрий";
    },
...
`const home = {
    label: "Главная",
    title: "Портфолио НВКЗ",
    description: "Сайт-портфолио Новокузнецкой школы креативных индустрий",
    headline: <>Новокузнецкая школа креативных индустрий</>,
    subline: (
      <>
        Образовательное учреждение, где студенты изучают современные технологии
        <br /> и креативные специальности.
      </>
    ),
};`,
    language: "tsx",
